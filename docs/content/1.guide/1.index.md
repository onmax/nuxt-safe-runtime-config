...
Inline runtime schemas are converted to JSON Schema. Importable schema modules execute the original Standard Schema at runtime, so transformations are preserved.
